		...
		<div class="content fl ml10">
			<div class="address_hd">
                ...
                <?php foreach ($models as $model):?>
                    <dl data-id="<?=$model->id?>">
                        <dt><?=$model->id?>.<?=$model->name?> <?= $model->cmbProvince?> <?=$model->cmbCity?> <?=$model->cmbArea?> <?=$model->address_detail?> <?=$model->tel?></dt>

                        <dd>
                            <a href="<?=\yii\helpers\Url::to(['member/edit-address','id'=>$model->id])?>">修改</a>
			...
			<div class="address_bd mt10">
				<h4>新增收货地址</h4>
				<form action="<?=\yii\helpers\Url::to(['member/add'])?>" name="address_form" method="post">
						<ul>
							<li>
							...
							<li>
								...
								<input type="text" name="address_detail" class="txt address"  />
							</li>
							<li>
